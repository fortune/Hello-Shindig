...
public interface SecurityTokenCodec {
   ...
   * 
   * createToken メソッドに渡す takenParameters からトークン文字列を取得するためのキー。
   */
   ...
   * 
   * createToken メソッドに渡す takenParameters から active url を取得するためのキー。
   */
   ...
   * 
   * takenParameters からトークン文字列、他を取り出して、セキュリティトークンを作成する。
   * 実装ごとに作成方法は異なるだろう。
   *
  ...
  //
  // SecurityToken からトークン文字列を作成する。
  // token を作成した実装で encodeToken する必要があるだろう。
  //
